class Playlist extends Track {
  ...
  //  return this.tracks[i].title += this.tracks[i].artist
    ...
    return `            
      ...
      <h4>Title: ${this.tracks[0].title}
      <h4>Artist: ${this.tracks[0].artist}
      <h4>Title: ${this.tracks[1].title}
      <h4>Artist: ${this.tracks[1].artist}
      <h4>Title: ${this.tracks[2].title}
      <h4>Artist: ${this.tracks[2].artist}

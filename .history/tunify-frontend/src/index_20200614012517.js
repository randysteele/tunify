...
document.addEventListener('DOMContentLoaded', () => {
  ...
  createPlaylistForm.addEventListener("submit", (e) => createFormHandler(e))
    ...
    function getPlaylists() {
      ...
      .then(list  => {
        ...
        const playlistMarkup = `    
          ...
          <h4> Artist: ${playlist.attributes.tracks.artist}             
            <h4>${playlist.attributes.tracks.name}
    ...
    .then(playlist => {
      ...
      const playlistMarkup = `
      <h3>Playlist Name: ${playlist.data.attributes.name}         
      <div data-id=${playlist.id}>      
      <h4> Artist: ${playlist.data.attributes.tracks.artist}             
      <h4>${playlist.data.attributes.tracks.name}

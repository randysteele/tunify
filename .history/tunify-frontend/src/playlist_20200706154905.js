class Playlist extends Track {
  ...
  renderPlaylistCard() {
     ...
     return   `            
      ...
      <h4>Title:  ${this.tracks[0].title} </h4>
      <h4>Artist: ${this.tracks[0].artist}</h4>
      <h4>Title:  ${this.tracks[1].title} </h4>
      <h4>Artist: ${this.tracks[1].artist}</h4>
      <h4>Title:  ${this.tracks[2].title} </h4>
      <h4>Artist: ${this.tracks[2].artist}</h4>
      <h4>Title:  ${this.tracks[3].title} </h4>
      <h4>Artist: ${this.tracks[3].artist}</h4>

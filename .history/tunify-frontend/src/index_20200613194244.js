...
document.addEventListener('DOMContentLoaded', () => {
  ...
  createPlaylistForm.addEventListener("submit", (e) => createFormHandler(e))
    ...
    .then(playlist => {
      ...
      <h4>${playlist.data.attributes.artist}<br>
      <h4>${playlist.data.attributes.image}<br>
      <h4>${playlist.data.attributes.preview}<br>
      <h4>${playlist.data.relationships.tracks} <br>
      <h4>${playlist.relationships.tracks}<br>    

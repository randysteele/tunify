...
function createFormHandler(e){
  ...
  postFetch(nameInput, addSongToPlaylist)
}
  
function postFetch(name, artist, image, preview, spotify_id) {
  let bodyData = {name, artist, image, preview, spotify_id}
  fetch(endpoint, {
    method: "POST",
  ...
  let addSongToPlaylist = document.getElementById("add-button");
  addSongToPlaylist.addEventListener("submit"), (e) => 

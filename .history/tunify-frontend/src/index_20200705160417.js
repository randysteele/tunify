...
document.addEventListener('DOMContentLoaded', () => {
 ...
 function getPlaylists() {
   ...
   var tracks = [playlist.attributes.tracks]
    function getFullPlaylist(item){
      var fullPlaylist = [item.title, item.artist].join(" ");
      

      return fullPlaylist
    }
    function myFunction(){
      document.getElementById("playlist-container").innerHTML = tracks.map(fullPlaylist)
    }

 ...
 function getPlaylists() {
    fetch(BACKEND_URL)
        ...
        .then(list  => {
          ...
          var myJSON = document.getElementById("playlist-container").JSON.stringify(newPlaylist.renderPlaylistCard())
           
          document.getElementById("playlist-container").innerHTML += myJSON()  

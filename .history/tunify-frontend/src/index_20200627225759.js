...
function getPlaylists() {
  fetch(BACKEND_URL)
      ...
      .then(list  => {
       ...
       let playlistTracks =  playlist.attributes.tracks[index].title +  playlist.attributes.tracks[index].artist // this works fine
       
    return   console.log(playlistTracks)
          
          
         document.getElementById('playlist-container').innerHTML +=  newPlaylist.renderPlaylistCard();  
        return playlistTracks //this does nothing 

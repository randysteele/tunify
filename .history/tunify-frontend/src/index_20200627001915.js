  ...
  fetch(BACKEND_URL)
      ...
      .then(list  => {
         ...
         // playlist.push(playlist)
          ...
          document.getElementById("playlist-container > div:nth-child(3) > h4:nth-child(1) > li").innerHTML += newPlaylist.renderPlaylistCard();   
  ...
  fetch(tracks_URL)
      ...
      .then(trk  => {
         ...
         // playlist.push(playlist)
          ...
          document.getElementById("playlist-container").innerHTML += withTracks += newTrack.renderTrackCard();   

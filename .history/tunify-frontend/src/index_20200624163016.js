      ...
      .then(list  => {
          list.data.forEach(playlist =>  {                      
           ...
           for (i = 0; i < playlist.attributes.length; i++) {
               ...
               let playlistTracksTitle =  playlist.attributes.tracks[i].title ;<br></br>
               let playlistTracksArtist = playlist.attributes.tracks[i].artist ;<br></br>
              

               document.getElementById("playlist-container").innerHTML += playlistTracksTitle += playlistTracksArtist += newPlaylist.renderPlaylistCard();

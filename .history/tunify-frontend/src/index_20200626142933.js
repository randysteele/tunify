  ...
  fetch(BACKEND_URL)
      ...
      .then(list  => {
          ...
          let newPlaylist = new Playlist(playlist, playlist.attributes);
           ...
           let withTracks = []
           withTracks.push(playlist.attributes.name, playlist.attributes.tracks[i].title)
           withTracks.push(playlist.attributes.name, playlist.attributes.tracks[i].artist)

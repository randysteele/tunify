  ...
  createPlaylistForm.addEventListener("submit", (e) => createFormHandler(e))
    ...
    function getPlaylists() {
      ...
      .then(list  => {
          ...
          <h3>Track Title ${playlist.attributes.tracks[0].name}
          <h3> Artist: ${playlist.attributes.tracks[0].artist}
        ...
        document.getElementById("playlist-container").innerHTML += playlistMarkup,join('')
            }
    ...
    function createFormHandler(e) {
      ...
      const trackInput = document.getElementById('track-title[0][value]').value.join

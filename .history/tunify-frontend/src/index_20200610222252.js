...
document.addEventListener('DOMContentLoaded', () => {
  ...
  .then(playlist =>{
    ...
    playlistContainer.insertAdjacentHTML('beforeend', trainerHTML);
    const playlistUl = document.querySelector(`[data-playlist-ul-id='${playlist.id}']`);
    playlist.data.forEach(playlist => {
      ...
      Remove
        ...
        playlistUl.insertAdjacentHTML('beforeend', trackHTML)
      })
    })
  }); 

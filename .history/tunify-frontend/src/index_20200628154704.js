...
document.addEventListener('DOMContentLoaded', () => {
  getPlaylists(); 
  getTracks();
  //onload = function(){ tracks-container.appendChild("playlist-container")}; 
...
function getTracks() {
  fetch(tracks_URL)
      ...
      .then(trk  => {
         ...
         document.getElementById('tracks-container').append('playlist-container').innerHTML += newTrack.renderTrackCard();   

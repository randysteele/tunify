...
function getPlaylists() {
  fetch(BACKEND_URL)
      ...
      .then(list  => {
         ...
         document.getElementById('tracks-container').innerHTML += playlist.attributes.tracks[0].title, playlist.attributes.tracks[0].artist, playlist.id += newPlaylist.renderPlaylistCard();   

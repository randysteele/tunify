      ...
      .then(list  => {
          list.data.forEach(playlist =>  {                        
           ...
           for (i = 0; i < playlist.attributes.length; i++) {
               ...
               document.getElementById("playlist-container").innerHTML += playlistTracksArtist += playlistTracksTitle += playlist.attributes.tracks[i].title += newPlaylist.renderPlaylistCard();

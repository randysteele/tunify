      ...
      .then(list  => {
        list.data.forEach(playlist =>  {      
           ...
           for (i = 0; i < playlist.length; i++) {
            for (t = 0; t < playlist.length; t++ ) {
           console.log(  playlist.attributes.tracks[i].artist, playlist.attributes.tracks[i].title)
            console.log( playlist.attributes.tracks[t].title, playlist.attributes.tracks[t].artist)
          }        }   

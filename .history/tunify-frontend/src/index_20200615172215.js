  ...
  fetch(BACKEND_URL)
      ...
      .then(list  => {
          list.data.forEach(playlist =>  {
              ...
              <h3>Track Title ${playlist.attributes.track[0].name}</h3>
              <h3> Artist: ${playlist.attributes.track[0].artist}</h3>          
              </div> 
              <br/><br/>`;
              //  debugger
    ...
    //  const playlistData = playlist.data
      const playlistMarkup = `
      <h3>Playlist Name: ${playlist.attributes.name}</h3>    
      <h3>Track Name: ${playlist.attributes.track[0].name}</h3  
      <h3>Track Name: ${playlist.attributes.track[0].artist}</h3   

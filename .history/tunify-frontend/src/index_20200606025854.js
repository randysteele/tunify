  ...
  list.data.forEach(playlist=> {
    const playlistMarkup = `
       <div data-id=${playlist.id}>
        <h4>Track Title: ${playlist.attributes.name}</h4>
...
let selectTracks = document.getElementById("playlist.tracks")
let allTracks = "";
let t;
for (t = 0; allTracks.length; t++){
  t = t + selectTracks[t].text + "<br>"
}

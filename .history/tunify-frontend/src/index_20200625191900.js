  ...
  fetch(BACKEND_URL)
      ...
      .then(list  => {
          list.data.forEach(playlist =>  {                      
           let newPlaylist = new Playlist(playlist, playlist.attributes).push(getTracks);
         ...
         //  let newTrack = new Track(track, track.attributes)
          ...
          document.getElementById("playlist-container").innerHTML += newTracks += newPlaylist.renderPlaylistCard();   

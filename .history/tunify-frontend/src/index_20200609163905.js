...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById("add-button").addEventListener("submit", (e) => addSongToPlaylist)
...
function postFetch(name, artist, image, preview, playlist_id) {
  ...
  // addSongToPlaylist.addEventListener("submit", (e) => createFormHandler(e));
    ...
    document.getElementById("playlist-container").innerHTML += playlistMarkup // this is the event listener for create playlist. 

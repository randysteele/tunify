...
function getPlaylists() {
  fetch(BACKEND_URL)
      ...
      .then(list  => {
       ...
       document.getElementById('playlist-container').innerHTML += playlist.attributes.tracks[index].artist += playlist.attributes.tracks[index].title +=newPlaylist.renderPlaylistCard();  

class Playlist extends Track {
  ...
  renderPlaylistCard() {
      ...
      <h4>Tracks: ${this.tracks[0].title}</h4>   
      <h4>Tracks: ${this.tracks[0].artist}</h4>
      <h4>Tracks: ${this.tracks[1].title}</h4>   
      <h4>Tracks: ${this.tracks[1].artist}</h4>   
      <h4>Tracks: ${this.tracks[2].title}</h4>   
      <h4>Tracks: ${this.tracks[2].artist}</h4>  
      <h4>Tracks: ${this.tracks[3].title}</h4>   
      <h4>Tracks: ${this.tracks[3].artist}</h4>  
      </div> </li>
      `;  

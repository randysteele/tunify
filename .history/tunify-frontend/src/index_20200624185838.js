      ...
      .then(list  => {
          list.data.forEach(playlist =>  {                      
           ...
           for (i = 0; i < playlist.attributes.length; i++) {
               ...
               playlistTracksArtist.push(getPlaylists)
               document.getElementById("playlist-container").innerHTML += newPlaylist.renderPlaylistCard();
               document.getElementById("playlist-container").innerHTML += playlistTracksTitle;
               document.getElementById("playlist-container").innerHTML += playlistTracksArtist;           

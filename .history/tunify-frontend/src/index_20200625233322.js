  ...
  fetch(BACKEND_URL)
      ...
      .then(list  => {
          ...
          let newPlaylist = new Playlist(playlist, playlist.attributes);
            // Playlist.all.push(playlist.attributes.title)
         //  let newTrack = new Track(track, track.attributes)
           let i;
          ...
          document.getElementById("playlist-container").innerHTML += newPlaylist.push(tracks.attributes[i].title).renderPlaylistCard();   

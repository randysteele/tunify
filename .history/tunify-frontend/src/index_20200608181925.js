...
function postFetch(name, artist, image, preview, spotify_id) {
  ...
  .then(playlist => {    
    ...
    const playContainer = document.getElementById('playlist-container').innerHTML += playlistMarkup
  ...
  li.appendChild(document.createTextNode("two"));
  const button = document.createElement("button")
  button.innerHTML = "Add This Track to Your Playlist"

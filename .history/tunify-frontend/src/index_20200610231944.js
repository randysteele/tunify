...
function newTrack(event){
 ...
 const renderPlaylists = (playlist_data)
  const div = document.createElement("div")
  const p = document.createElement("p")
  const button = document.createElement("button")
  const ukl = document.createElement("ul")
  div.setAttribute("class", "card")
  div.setAttribute("data-id", getPlaylists.id)
  p.innerText = getPlaylists
  button.setAttribute("data-playlist.id", getPlaylists.id)

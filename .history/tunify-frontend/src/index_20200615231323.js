...
function getPlaylists() {
  fetch(BACKEND_URL)
    ...
    function createFormHandler(e) {
      ...
      const trackInput = document.getElementById('tracks').value
      const trackId = parseInt(document.getElementById('track').value)
      postFetch(nameInput, trackInput, trackId)      
    }

    function postFetch(name, track_id, track){
    ...
    //  const playlistData = playlist.data
      ...
      <h3> Track: ${playlist.attributes.track.name}  

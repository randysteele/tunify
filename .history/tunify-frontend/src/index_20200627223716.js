  ...
  fetch(BACKEND_URL)
      ...
      .then(list  => {
       list.data.map((playlist, index)  =>  {      
         ...
         document.getElementById('playlist-container').innerHTML += playlist.attributes.tracks[index].title, playlist.attributes.tracks[index].artist += newPlaylist.renderPlaylistCard();  

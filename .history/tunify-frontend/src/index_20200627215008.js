...
function getPlaylists() {
  fetch(BACKEND_URL)
      ...
      .then(list  => {
        ...
        //  playlist.attributes.tracks(index).artist, playlist.attributes.tracks(index).artist
       // console.log( "The current iteration is: " + index);
       // console.log("The current element is: " + playlist.attributes.tracks[index].title);
       // console.log("\n");
        const playlistTracks =  playlist.attributes.tracks[index].title
          // let withTracks = []
          // withTracks.push(playlist.attributes.tracks.artist, playlist.attributes.tracks.title)

          // this.title = playlistAttributes.tracks[0].title
          // this.artist = playlistAttributes.tracks[0].artist

         document.getElementById('playlist-container').innerHTML += playlistTracks += newPlaylist.renderPlaylistCard();   

  ...
  fetch(BACKEND_URL)
     ...
     // playlist.attributes.name, playlist.attributes.tracks[index].artist, playlist.attributes.tracks[index].title
       ...
       document.getElementById('playlist-container').innerHTML +=  newPlaylist.renderPlaylistCard();  
        document.getElementById('playlist-container').innerHTML += playlist.attributes.name, playlist.attributes.tracks[index].artist, playlist.attributes.tracks[index].title

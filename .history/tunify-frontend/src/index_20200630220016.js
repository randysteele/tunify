  ...
  fetch(BACKEND_URL)
      ...
      .then(list  => {
        list.data.forEach(playlist =>  {      
          ...
          //  for (let t = 0; playlist[i].length; t++ ) <<not needed?
           trackDetails.push(playlist.attributes.tracks[i].title, playlist.attributes.tracks[i].artist)
           Object.valueOf(playlist.attributes.name, playlist.attributes.tracks[i].title, playlist.attributes.tracks[i].artist)
          }
          
          
         console.log(Object.valueOf(playlist.attributes.name, playlist.attributes.tracks[i].title, playlist.attributes.tracks[i].artist))

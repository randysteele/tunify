...
function getPlaylists() {
  fetch(BACKEND_URL)
      ...
      .then(list  => {
          ...
          playlistCont.innerHTML = newPlaylist.renderTrackCard();
...
function getTracks() {
  fetch(tracks_URL)
      ...
      .then(trk  => {
          ...
          let trackCont = document.createElement("tracks-cont");
          trackCont.innerHTML = newTrack.renderTrackCard();
          document.body.appendChild(trackCont);

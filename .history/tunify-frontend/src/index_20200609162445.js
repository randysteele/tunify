...
function getPlaylists(){
  ...
  list.data.forEach(playlist=> {
    const playlistMarkup =     `    
       ...
       <input id="playlist-container" type ="submit" name="submit" value="Add ${playlist.attributes.name} To Playlist"> 
...
function postFetch(name, artist, image, preview, playlist_id) {
  ...
  const addSongToPlaylist = document.getElementById("playlist-container");

...
function getPlaylists() {
  fetch(BACKEND_URL)
      ...
      .then(list  => {
          ...
          let newPlaylist = new Playlist(playlist, playlist.attributes, tracks, tracks.attributes);

           let withTracks = []
             withTracks.push(console.log(playlist.attributes.name, tracks.attributes))
         // playlist.push(playlist)
          ...
          document.getElementById("playlist-container").innerHTML += withTracks += newPlaylist.renderPlaylistCard();   

...
function getPlaylists() {
  fetch(BACKEND_URL)
      ...
      .then(list  => {
         ...
         document.getElementsById('tracks-container').innerHTML += newPlaylist.renderPlaylistCard();   
  ...
  fetch(tracks_URL)
      ...
      .then(trk  => {
         ...
         // let playlistTracks = document.createElement("playlist-tracks")
          ...
          //document.body.appendChild("playlistCont");
          document.getElementsById('tracks-container').innerHTML += newTrack.renderTrackCard();   
          }
      )}
  )
}
    ...
    .then(playlist => {          
      ...
      document.getElementsByClassName('full-playlist').innerHTML += newPlaylist.renderPlaylistCard() ;

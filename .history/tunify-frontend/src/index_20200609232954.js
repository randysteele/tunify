...
const endpoint = 'http://localhost:3000/api/v1/playlists/top_country'
...
function getPlaylists(){
  ...
  list.data.forEach(playlist=> {
    const playlistMarkup =     `    
       ...
       <input id="add-button" type ="click" name="click" value="Add ${playlist.attributes.name} To Playlist"> 

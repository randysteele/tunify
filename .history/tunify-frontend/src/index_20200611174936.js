...
function getPlaylists() {
  ...
  .then(playlist  => {
    ...
    const playlistMarkup =     `    
       ...
       <select>Name: ${playlist.attributes.name}</select>
       <select id="add-button.playlist.id" type ="submit" name="submit" value="Add ${playlist.attributes.spotify_id[0]} To Playlist"></select>

...
newsong = Song.create(title: "My newest song", song_id: songs.id)
favsong = Song.create(title: "my fav song", song_id: songs.id)
leastfav = Song.create(title: "I hate this song", song_id: songs.id)
